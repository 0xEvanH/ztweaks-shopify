...
> & {
  ...
  video?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
};
...
export type ZTweaksProductsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type ZTweaksProductsQuery = {
  products: {
    nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ZTweaksProducts {\n    products(first: 10, sortKey: CREATED_AT) {\n      nodes {\n        id\n        title\n        handle\n        description\n        priceRange {\n          minVariantPrice { amount currencyCode }\n        }\n        variants(first: 1) {\n          nodes {\n            id\n            availableForSale\n            selectedOptions { name value }\n          }\n        }\n        featuredImage { url altText }\n        metafields(identifiers: [\n          { namespace: "ztweaks", key: "category" }\n          { namespace: "ztweaks", key: "video"    }\n          { namespace: "ztweaks", key: "tags"     }\n          { namespace: "ztweaks", key: "badge"    }\n          { namespace: "ztweaks", key: "original_price" }\n          { namespace: "ztweaks", key: "featured" }\n          { namespace: "ztweaks", key: "period"   }\n        ]) { key value }\n      }\n    }\n  }\n': {
    return: ZTweaksProductsQuery;
    variables: ZTweaksProductsQueryVariables;
  };
